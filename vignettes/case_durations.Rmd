...
#> Coefficients: 
#>                      Estimate  Std. Error  Z-Test  Pr(>|Z|)    
#> log(scale)_omega   0.26955741  0.04763575  5.6587 1.525e-08 ***
#> log(scale)_beta1  -0.00302892  0.00039014 -7.7638 8.244e-15 ***
#> log(scale)_alpha1  0.06215424  0.00992563  6.2620 3.801e-10 ***
#> log(scale)_phi1    0.90950195  0.02399584 37.9025 < 2.2e-16 ***
#> shape              0.94858383  0.00949927 99.8586 < 2.2e-16 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> 
...
#> Coefficients: 
#>                      Estimate  Std. Error  Z-Test  Pr(>|Z|)    
#> log(scale)_omega  -0.70489176  0.19283438 -3.6554 0.0002568 ***
#> log(scale)_beta1  -0.00292746  0.00039123 -7.4827 7.280e-14 ***
#> log(scale)_alpha1  0.08164958  0.01387329  5.8854 3.971e-09 ***
#> log(scale)_phi1    0.87684183  0.03506612 25.0054 < 2.2e-16 ***
#> shape1             1.76342711  0.15253551 11.5608 < 2.2e-16 ***
#> shape2             0.68568217  0.03426456 20.0114 < 2.2e-16 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> 
...
#> log(scale)_omega  -0.704891757 -0.691650417 0.22759165       0 -1.171868984 -0.342255708
#> log(scale)_beta1  -0.002927462 -0.002946901 0.00035879       0 -0.003656872 -0.002238183
#> log(scale)_alpha1  0.081649576  0.080128593 0.01164234       0  0.056643028  0.105426070
#> log(scale)_phi1    0.876841834  0.871097748 0.03637299       0  0.798610795  0.922273459
#> shape1             1.763427106  1.756371114 0.18391065       0  1.467043066  2.122748997
#> shape2             0.685682170  0.690872213 0.03914670       0  0.613915496  0.760901301
```
...
#>     -3.475727e-02      3.243935e-05      2.230949e-03     -1.306872e-03     -3.137514e-02 
#>            shape2 
#>     -4.882134e-03
```
...
#> 1.00983688 0.70607057 1.13925461 0.11283487 0.25271219 2.26864169 2.27106585 0.74223170 0.67659592 
#>        t10        t11        t12        t13        t14        t15        t16        t17        t18 
#> 0.25904234 0.00483613 0.07708057 0.60851088 0.79944972 1.12612404 0.15735179 0.12406722 0.10016870 
#>        t19        t20 
#> 0.64812192 0.21998355
```
