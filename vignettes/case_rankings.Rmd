...
<img src="rankings_tv-1.png" alt="Time-varying parameters of the Canada team based on the static model." width="75%" />
...
<div class="figure" style="text-align: center">
<img src="rankings_tv-2.png" alt="Time-varying parameters of the Canada team based on the stationary model." width="75%" />
...
<div class="figure" style="text-align: center">
<img src="rankings_tv-3.png" alt="Time-varying parameters of the Canada team based on the random walk model." width="75%" />
...
<div class="figure" style="text-align: center">
<img src="rankings_band-1.png" alt="Confidence band of time-varying parameters of the Canada team based on the stationary model." width="75%" />
<p class="caption">Confidence band of time-varying parameters of the Canada team based on the stationary model.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="rankings_ahead-1.png" alt="One-step ahead forecasts of the Canada team based on the stationary model." width="75%" />
