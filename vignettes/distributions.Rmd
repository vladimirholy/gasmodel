...
\nabla_{s} (y; m, s) &= \frac{ y - m}{s (1 + s m)} + \frac{1}{s^2} \left( \ln(1 + s m) + \psi_0 \left( s^{-1} \right) - \psi_0 \left( y + s^{-1} \right) \right) \\
\end{aligned}
$$
...
- Location parameters $m_i \in \mathbb{R}, i = 1, \ldots, n$
- Scale parameters $s_i \in (0, \infty), i = 1, \ldots, n$
- Covariance parameters $c_{ij} \in \mathbb{R}, i = 2, \ldots, n, j = 1, \ldots, i$

#### Matrix Notation

- Location vector $\boldsymbol{m}$ of length $n$
