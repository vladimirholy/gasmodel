...
#'
#' The included datasets are \code{\link[gasmodel:bookshop_sales]{bookshop_sales}}, \code{\link[gasmodel:ice_hockey_championships]{ice_hockey_championships}} and \code{\link[gasmodel:sp500_daily]{sp500_daily}}.
#'
#' @references
