...
# Parameters Function ----------------------------------------------------------
distr_t_mean_var_parameters <- function(n) {
...
# Density Function -------------------------------------------------------------
distr_t_mean_var_density <- function(y, f) {
  t <- nrow(f)
  m <- f[, 1, drop = FALSE]
  s <- f[, 2, drop = FALSE]
  v <- f[, 3, drop = FALSE]
...
distr_t_mean_var_loglik <- function(y, f) {
  t <- nrow(f)
  m <- f[, 1, drop = FALSE]
  s <- f[, 2, drop = FALSE]
  v <- f[, 3, drop = FALSE]
...
# Mean Function ----------------------------------------------------------------
distr_t_mean_var_mean <- function(f) {
  t <- nrow(f)
  m <- f[, 1, drop = FALSE]
  s <- f[, 2, drop = FALSE]
  v <- f[, 3, drop = FALSE]
...
# Variance Function ------------------------------------------------------------
distr_t_mean_var_var <- function(f) {
  t <- nrow(f)
  m <- f[, 1, drop = FALSE]
  s <- f[, 2, drop = FALSE]
  v <- f[, 3, drop = FALSE]
...
# Score Function ---------------------------------------------------------------
distr_t_mean_var_score <- function(y, f) {
  t <- nrow(f)
  m <- f[, 1, drop = FALSE]
  s <- f[, 2, drop = FALSE]
  v <- f[, 3, drop = FALSE]
...
distr_t_mean_var_fisher <- function(f) {
  t <- nrow(f)
  m <- f[, 1, drop = FALSE]
  s <- f[, 2, drop = FALSE]
  v <- f[, 3, drop = FALSE]
...
distr_t_mean_var_random <- function(t, f) {
  m <- f[1]
  s <- f[2]
  v <- f[3]
...
distr_t_mean_var_start <- function(y) {
